...
Item {
    ...
    function fillDeck() {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            // two draw2/skip/reverse cards per color 每一种颜色有 draw2/skip/reverse
            for (var l = 10; l <= 12; l++) {
                for (var m = 0; m < 2; m++) {
                    card = {
        ...
        // create four black wild and four wild4 cards 创建4个blackwild 和4张wild4
        for (var n = 13; n <= 14; n++) {
            for (var o = 0; o < 4; o++) {
                card = {
    ...
    // 在游戏开始的时候，领导者将洗牌（shuffles the cardinfo）
